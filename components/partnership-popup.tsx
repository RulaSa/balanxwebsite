  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-orange-50 via-orange-100 to-amber-100 rounded-2xl p-8 max-w-lg w-full relative">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 left-4 w-8 h-8 bg-white border border-gray-300 text-black rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors"
        >
